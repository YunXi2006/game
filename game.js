...
const ITEM_DESCRIPTIONS = {
  ...
  '告示碎片':
    '一張印有校園設施資訊的碎紙，其中一行讓李白停住了目光——「古典文獻閱覽室：本週主題展——『城居者未之知：唐代出走者的頓悟』，展出珍稀古卷。」命運的線索，從這張無人在意的紙開始。',
  '子時啟陣密語':
    '從古卷封底隱字辨認出的啟陣條件：「子時三更，月滿中庭，以詩換門，以酒啟陣——啟陣之前，須解城居者未之知之真意，方可入門。」子時、月圓、酒，以及那道關乎「知」的考驗——缺一不可。',
  '時輪陣圖草稿':
    '白髮老先生研究三十年的手繪草圖，描繪時輪陣的完整結構。啟動條件：古水之源、子時月滿、以酒為媒，並須由原作者帶著真情吟唱，氣場才能共鳴。另附注：陣法啟動前有最後一問，考驗旅者是否真正走出了城居之境。',
  '教授研究報告摘要':
    '古典文學教授的田野調查節錄。確認清月井舊址位於校園東北角，唐代地下水脈殘存，現為石板廣場。另記：啟動時須由原作者帶著真情吟唱，陣法才能感應氣場共鳴。最後一關：需回答袁宏道《滿井遊記》末句「城居者未之知也」中「知」字的真義——親身感受，而非頭腦知識。',
  '清月井路線':
...
function resolveText(sceneId, scene) {
  ...
  if (sceneId === 'scene_5_4') {
    ...
    const inscriptionLine = hasInscription
      ...
      : '';
    return `翌日清晨，幾個早起的學生路過東北角廣場，發現石板縫隙中盛開了幾株無人認識的野花，淡黃色，帶著穀物與山泉混合的氣味。圖書館那本古卷的封底，隱紋消失了。${inscriptionLine}只有風，還在從東北方吹來。`;
  }
